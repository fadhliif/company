            ...
            <td><center><div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                      <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                          <img class="d-block w-75" src="<?php echo base_url() ?>assets/img/industri2.jpg" height="350px"  alt="Second slide" >
                        </div>
                        <div class="carousel-item">
                          <img class="d-block w-75" src="<?php echo base_url() ?>assets/img/indsutri3.jpg" height="350px"  alt="Third slide" >
                        </div>
                      </div>
                    </div></center></td>
